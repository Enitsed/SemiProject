	...
	<div id="templatemo_wrapper">
		...
		<div id="templatemo_main">
			...
			<div class="col two-third">
				...
				<p>
					Morbi adipiscing gravida lacus, id rhoncus neque sollicitudin ac.
					Sed eget purus vitae enim pulvinar viverra. Cras ut elit et ligula
					blandit eleifend. Nam at odio sem, sed tempor justo. Validate <a
				...
				<div id="contact_form">
					<form method="post" name="contact" action="#">
						...
						<input type="submit" class="submit_btn left" name="submit"
							...
							class="submit_btn right" name="reset" id="reset" value="Reset" />
			...
			<div class="col one_third no_margin_right">
				<h4>Office One</h4>
				330-550 Quisque diam at ligula, <br /> Etiam dictum lectus quis,
				11220<br /> Sed mattis mi at sapien<br /> <br /> Phone:
				090-010-0990<br /> <strong>Email:</strong> <a
					href="mailto:info@company.com">info@company.com</a><br />

				<div class="cleaner h40"></div>

				<h4>Office Two</h4>
				120-360 Cras ac nunc laoreet,<br /> Nulla vitae leo ac dui, 10680<br />
				Cras id sem nulla<br /> <br /> Phone: 040-060-0460<br /> <strong>Email:</strong>
				...
				<br /> <small><a
					href="http://maps.google.com/maps?f=q&amp;source=embed&amp;hl=en&amp;geocode=&amp;q=new+york+central+park&amp;aq=&amp;sll=37.0625,-95.677068&amp;sspn=60.158465,135.263672&amp;vpsrc=6&amp;ie=UTF8&amp;hq=&amp;hnear=Central+Park,+New+York&amp;t=m&amp;ll=40.769606,-73.973372&amp;spn=0.014284,0.033023&amp;z=14"
					target="_blank" style="color: #0000FF; text-align: left">View
						Larger Map</a></small>
			</div>
			<div class="clear"></div>
		</div>
